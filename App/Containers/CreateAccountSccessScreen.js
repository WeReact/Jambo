...
import styles from './Styles/CreateAccountSccessScreenStyles';

export default class CreateAccountSccessScreen extends Component {
			...
			<View style={styles.wrapper}>
				<View style={styles.content}>
					<Animated.View style={[{ transform: [{ scale: iconScale }] }]}>
						<Icon name="check" color={Colors.orangeAccent} size={120} />
					</Animated.View>
					<View>
						<Text style={styles.title}>{'Conta Criada com Sucesso!'}</Text>
						<Text style={styles.description}>
							{'Agora você pode logar no nosso App, vamos lá?'}
						</Text>
					</View>
					<TouchableHighlight
